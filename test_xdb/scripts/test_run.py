...
for target in targets:
    ...
    ## test that excluded models throw a compilation error or warning
    ...
    _, errs = exceptions_text.communicate()

    passed = any([val in errs for val in (b'Compilation Error', b'WARNING: Nothing to do',)])

    print("\033[0;32mAnticipated error(s) correctly thrown, exceptions pass.\033[0m"
          if passed else "\033[0;31mExpected error not thrown!\033[0m")
